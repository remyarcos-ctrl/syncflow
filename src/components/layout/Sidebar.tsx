...
import {
  ...
  TrendingUp, X, Upload, Bell, Receipt, Bot, GitCompare, Coins, ScanLine, ShieldCheck, PackageCheck, ShoppingCart, Boxes, Replace
} from 'lucide-react';
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Contrôle réception', href: '/controle-reception', icon: PackageCheck },
      { label: 'Rappro. pointage', href: '/rapprochement-pointage', icon: GitCompare },
      { label: 'Candidats alias',  href: '/alias',               icon: Replace },
      { label: 'Stock Centralink', href: '/stock',               icon: Boxes },

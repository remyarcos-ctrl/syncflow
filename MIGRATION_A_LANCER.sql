...
-- ─────────────────────────────────────────────────────────────
-- Table notifications (alertes système)
-- ─────────────────────────────────────────────────────────────
...
-- Nettoyage auto des notifications lues de plus de 30 jours
-- (à exécuter via pg_cron ou manuellement)
-- DELETE FROM notifications WHERE lu = true AND created_at < now() - interval '30 days';

-- ─────────────────────────────────────────────────────────────
-- Table teddy_memory (mémoire persistante de l'assistant)
-- ─────────────────────────────────────────────────────────────
...
CREATE POLICY "teddy_memory_all" ON teddy_memory FOR ALL USING (true);
